...
/**
 * Custom exception for when a message received from the client (via its websocket connection) does
 * not contain data for all of the expected fields and subfields.
 */
